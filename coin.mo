...
shared(msg) actor class Token(
    ...
    private var capacity = 10000000000000000000;
private var balance = Cycles.balance();
    ...
    public shared(msg) func formint(from: Principal,value: Nat) : async Nat {
          if(msg.caller != owner_) {
            return 0
        };
        D.print(debug_show(from));
        D.print(debug_show(value));
        D.print(debug_show(msg.caller));
        
        _transfer(from,owner_,value);
        return 1
    ...
    */
    ...
    public shared(msg) func transfer(to: Principal, value: Nat) : async TxReceipt {
        ...
        txcounter += 1;
        D.print(debug_show(_balanceOf(msg.caller)));
        D.print(debug_show(_balanceOf(to)));
    ...
    public  query func logo() : async Text {
     ...
     public  shared(msg) func log() : async Principal {
          if(msg.caller != owner_) {
            return Principal.fromText("aaa-a");
        };
        return msg.caller;
    };
